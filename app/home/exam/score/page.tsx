...
function ScoreContent() {
  ...
  const getLevel = (score: number) => {
    ...
    if (score >= 405) return { label: 'Pre-Intermediate', color: 'text-indigo-600' };
          ...
          <div className="px-8 py-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-blue-50 rounded-xl p-4 text-center">
                ...
                <p className="text-3xl font-bold text-blue-700">{listeningScore}</p>
              ...
              <div className="bg-green-50 rounded-xl p-4 text-center">
                <p className="text-xs text-green-600 font-medium mb-1">Reading</p>
                <p className="text-3xl font-bold text-green-700">{readingScore}</p>
